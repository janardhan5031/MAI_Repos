      ...
      <div className="h-full flex justify-center items-center">
        <div className="fixed top-0 left-0 flex flex-col items-center justify-center w-full h-full z-50">
          <div className="relative w-40 h-40">
            <div
              className="inline-block h-40 w-40 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] text-primary motion-reduce:animate-[loader_1.5s_linear_infinite]"
              role="status"
            ></div>
            <img
              src={mai}
